        ...
        <form noValidate="" action="" className="space-y-6">
          ...
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              className="w-full bg-gray-200 px-4 py-3 rounded-md dark:border-gray-300 "
            />
          ...
          <button className="block w-full p-3 text-center bg-gray-800 text-white rounded cursor-pointer">
            Sign Up
          </button>
        </form>
